...
const HeroSection = () => (
  <section className="bg-white rounded-3xl shadow-lg p-8 mt-8 flex flex-col md:flex-row items-center justify-between">
    <div className="flex-1">
      <h1 className="text-5xl md:text-7xl font-extrabold text-brown-900 mb-4">
        <span className="text-yellow-500">BAKE</span> <span className="text-green-600">TASTY</span> THE <span className="text-orange-600">COOKIES</span> <span className="text-red-500">CRUNCHY</span>
      </h1>
